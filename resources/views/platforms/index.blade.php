              ...
              <div class="relative z-10 flex justify-between max-w-728 w-full">
                <div class="max-w-336 w-full mr-8">
                    ...
                    <p class="text-solstice-blue-opacity-60 mb-6 leading-normal">
                        eShangazi supports a number of platforms and you can quickly define here a new platform to the list so that it can be supported.
                    </p>
            ...
            <main class="min-h-full w-full">
                <div class="flex flex-col flex-1">
                    <div class="p-4 border-dashed border border-proton-grey-opacity-80 rounded text-solstice-blue group m-4 flex-1">
                        ...
                        <div>
                            <div class="">
                                <h4 class="subtitle">There are {{ $platforms->count() }} platforms so far...</h4>
                                    ...
                                    @else
                                        <ul class="list-reset">
                                            @foreach($platforms as $platform)
                                                <a href="{{ route('show-platform', $platform) }}" class="hover:no-underline text-grey-darkest">
