                ...
                <div class="relative z-10 flex justify-between max-w-728 w-full">
                    <div class="max-w-336 w-full mr-8">
                        ...
                        <p class="text-solstice-blue-opacity-60 mb-6 leading-normal">
                            Sending message to members when required, remember to add message title in <a href="https://dialogflow.com" target="_blank">Dialogflow</a>.
                        </p>
            ...
            <main class="min-h-full w-full">
                <div class="flex flex-col flex-1">
                    <div class="p-4 border-dashed border border-proton-grey-opacity-80 rounded text-solstice-blue group m-4 flex-1">
                        ...
                        <div>
                            <div class="">
                                <h4 class="subtitle">There are {{ $messages->count() }} messages so far...</h4>
                                    ...
                                    @else
                                        <ul class="list-reset">
                                            @foreach($messages as $message)
                                                <a href="{{ route('show-message', $message) }}" class="hover:no-underline text-grey-darkest">
