...
@section('content')
    <category-item-detail-view inline-template :category="{{ $item_category }}" :user={{ auth()->id() }}>
                        ...
                        <div class="p-4 border-dashed border border-proton-grey-opacity-80 rounded text-solstice-blue group m-4 flex-1">
                            ...
                            <div>
                                ...
                                <div class="">
                                    ...
                                    <div>
                                        <ul class="list-reset" v-for="(item, index) in items" :key="item.id" v-if="items.length">
